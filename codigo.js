...
const IDBRequest = indexedDB.open("pilarbase", 1);//abrimos una base de datos o la crea/ esta es la solicitud

IDBRequest.addEventListener("upgradeneeded", () => {
    const db = IDBRequest.result;//aca agregamos las tablas
    db.createObjectStore("nombres", {
        autoIncrement: true//esto se va incrementando para que no haya dos elementos con el mismo numero //es como el ID, este key tiene que ser unico, para identificar un objeto. 
